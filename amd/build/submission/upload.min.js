define(['local_processfeedback/services/payload', 'local_processfeedback/services/zip_builder', 'local_processfeedback/diff_match_patch', 'local_processfeedback/state/store', 'local_processfeedback/utils/logger', 'core/config'], function(__dep0, __dep1, __dep2, __dep3, __dep4, __dep5) {
...
const DiffMatchPatch = __dep2.DiffMatchPatch;
const getString = __dep3.getString;
...
const uploadProcessFeedbackSubmission = async(state, revisionStore, autosaveService, windowRef) => {
...
return { uploadProcessFeedbackSubmission };
});