define(['local_processfeedback/submission/upload', 'local_processfeedback/utils/logger'], function(__dep0, __dep1) {
const uploadProcessFeedbackSubmission = __dep0.uploadProcessFeedbackSubmission;
...
const initSubmissionInterceptor = (state, revisionStore, autosaveService, windowRef, documentRef) => {
...
return { initSubmissionInterceptor };
});