define(['core/str', 'local_processfeedback/utils/logger'], function(__dep0, __dep1) {
const Str = __dep0;
const debugLog = __dep1.debugLog;
...
const ZIP_LINK_SELECTOR = 'a[data-processfeedback-zip="true"]';
const DASHBOARD_TOOLBAR_CLASS = 'local-processfeedback-dashboard-report-action';
const SINGLE_REPORT_ACTION_CLASS = 'local-processfeedback-single-report-action';
const SINGLE_REPORT_STATUS_CLASS = 'local-processfeedback-single-report-status';
const SINGLE_REPORT_BUTTON_CLASS = 'local-processfeedback-single-report-button';
...
const getProcessFeedbackZipLinks = (documentRef) => {
    const seen = new Set();
...
const createProcessFeedbackButton = (documentRef, label, extraClass = '') => {
...
const markProcessFeedbackSubmissionTables = (links) => {
    links.forEach((link) => {
...
const createProcessFeedbackSubmissionMessage = (submission, batchId, chunkIndex = 0, totalChunks = 1) => ({
...
const sendZipLinksToProcessFeedback = async (
    links,
    button,
    status,
    windowRef,
...
const sendZipBlobToProcessFeedback = async(blob, metadata, status, windowRef, explorerParams = {}, existingTargetWindow = null) => {
...
return { ZIP_LINK_SELECTOR, DASHBOARD_TOOLBAR_CLASS, SINGLE_REPORT_ACTION_CLASS, SINGLE_REPORT_STATUS_CLASS, SINGLE_REPORT_BUTTON_CLASS, getProcessFeedbackZipLinks, createProcessFeedbackButton, markProcessFeedbackSubmissionTables, createProcessFeedbackSubmissionMessage, sendZipLinksToProcessFeedback, sendZipBlobToProcessFeedback };
});