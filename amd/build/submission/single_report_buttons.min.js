...
const SINGLE_REPORT_ACTION_CLASS = __dep1.SINGLE_REPORT_ACTION_CLASS;
const SINGLE_REPORT_BUTTON_CLASS = __dep1.SINGLE_REPORT_BUTTON_CLASS;
const SINGLE_REPORT_STATUS_CLASS = __dep1.SINGLE_REPORT_STATUS_CLASS;
...
const getSingleWritingProcessReportLinks = (documentRef) => {
...
const initSingleWritingProcessReportButtons = async(windowRef, documentRef, state = null) => {
    let buttonsAdded = 0;
...
return { getSingleWritingProcessReportLinks, initSingleWritingProcessReportButtons };
});