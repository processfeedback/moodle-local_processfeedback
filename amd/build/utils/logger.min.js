...
const DEBUG_LOG_KEY = 'local_processfeedback:debug';
const DEBUG_EXPORT_STEPS_KEY = 'local_processfeedback:debug_export_steps';
...
const isDebugLoggingEnabled = (windowRef = null) => hasTruthyLocalStorageValue(
    windowRef,
    [DEBUG_LOG_KEY].concat(LEGACY_DEBUG_LOG_KEYS)
);

const isDebugExportStepsEnabled = (windowRef = null) => hasTruthyLocalStorageValue(
    windowRef,
...
const debugLog = (windowRef, message, details = null) => {
    writeConsole('log', windowRef, message, details);
};

const debugWarn = (windowRef, message, details = null) => {
    writeConsole('warn', windowRef, message, details);
};

const debugError = (windowRef, message, details = null) => {
    writeConsole('error', windowRef, message, details);
};
return { DEBUG_LOG_KEY, DEBUG_EXPORT_STEPS_KEY, isDebugLoggingEnabled, isDebugExportStepsEnabled, debugLog, debugWarn, debugError };
});