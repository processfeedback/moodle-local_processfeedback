define(['local_processfeedback/components/panel', 'local_processfeedback/components/editor', 'local_processfeedback/services/autosave', 'local_processfeedback/services/bootstrap', 'local_processfeedback/services/export_zip', 'local_processfeedback/services/revisions', 'local_processfeedback/services/storage', 'local_processfeedback/state/store', 'local_processfeedback/submission/interceptor', 'local_processfeedback/utils/notifications', 'local_processfeedback/submission/assignment_report_actions', 'local_processfeedback/submission/single_report_buttons', 'local_processfeedback/utils/logger'], function(__dep0, __dep1, __dep2, __dep3, __dep4, __dep5, __dep6, __dep7, __dep8, __dep9, __dep10, __dep11, __dep12) {
const createPanel = __dep0.createPanel;
const getAssignmentEditorPlacementTarget = __dep0.getAssignmentEditorPlacementTarget;
const getAssignmentStatusPlacementTarget = __dep0.getAssignmentStatusPlacementTarget;
const getForumBoardPlacementTarget = __dep0.getForumBoardPlacementTarget;
const PANEL_CLASS = __dep0.PANEL_CLASS;
const createEditorBinder = __dep1.createEditorBinder;
const createAutosaveService = __dep2.createAutosaveService;
const fetchBootstrapData = __dep3.fetchBootstrapData;
const createZipExportService = __dep4.createZipExportService;
const createRevisionStore = __dep5.createRevisionStore;
const createStorage = __dep6.createStorage;
const createState = __dep7.createState;
const ensureProjectId = __dep7.ensureProjectId;
const initSubmissionInterceptor = __dep8.initSubmissionInterceptor;
const notifyException = __dep9.notifyException;
const initAssignmentReportActions = __dep10.initAssignmentReportActions;
const getSingleWritingProcessReportLinks = __dep11.getSingleWritingProcessReportLinks;
const debugError = __dep12.debugError;
const debugLog = __dep12.debugLog;
 ...
 * @return {Promise<void>}
 */
const init = async(configOrContextid, cmid) => {
