define(['local_processfeedback/utils/logger'], function(__dep0) {
const debugLog = __dep0.debugLog;
 ...
 * @return {boolean}
 */
const isPasteEvent = (event) => PASTE_EVENT_TYPES.indexOf(getEventType(event)) !== -1;
...
const createEditorBinder = (state, windowRef, documentRef) => {
    let boundEditors = {};
...
return { isPasteEvent, getPasteEventText, createEditorBinder };
});