define(['local_processfeedback/diff_match_patch'], function(__dep0) {
const DiffMatchPatch = __dep0.DiffMatchPatch;
/**
 ...
 */
const buildSnapshot = (currentText, previousText, previousTimestamp, snapshotIndex, saveFullEvery) => {
    const isAnchor =
        !previousText ||
        !previousTimestamp ||
