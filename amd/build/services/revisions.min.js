define(['local_processfeedback/services/snapshots', 'local_processfeedback/state/store', 'local_processfeedback/utils/logger', 'local_processfeedback/utils/url'], function(__dep0, __dep1, __dep2, __dep3) {
const buildSnapshot = __dep0.buildSnapshot;
const getActivityTitle = __dep1.getActivityTitle;
const getStoreName = __dep1.getStoreName;
const getString = __dep1.getString;
const debugLog = __dep2.debugLog;
const safeHref = __dep3.safeHref;
...
const createRevisionStore = (state, storage, windowRef) => {
