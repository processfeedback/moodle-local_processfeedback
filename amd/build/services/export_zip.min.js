define(['local_processfeedback/services/payload', 'local_processfeedback/services/zip_builder', 'local_processfeedback/state/store', 'local_processfeedback/submission/report_transfer', 'local_processfeedback/utils/logger'], function(__dep0, __dep1, __dep2, __dep3, __dep4) {
const createPayload = __dep0.createPayload;
const buildZipBlob = __dep1.buildZipBlob;
const getProcessZipFilename = __dep1.getProcessZipFilename;
const getString = __dep2.getString;
const sendZipBlobToProcessFeedback = __dep3.sendZipBlobToProcessFeedback;
const debugError = __dep4.debugError;
const debugLog = __dep4.debugLog;
...
const createZipExportService = (state, revisionStore, autosaveService, panel, windowRef, documentRef) => {
