define(['local_processfeedback/state/store'], function(__dep0) {
const getStoreName = __dep0.getStoreName;
...
const getCaptureState = async(storage, state) => {
...
const setCapturePaused = async(storage, state, paused) => {
    const context = getContext(state);
...
return { getCaptureState, setCapturePaused };
});