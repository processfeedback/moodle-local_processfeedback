define(['local_processfeedback/components/editor', 'local_processfeedback/state/store', 'local_processfeedback/utils/hash', 'local_processfeedback/utils/logger'], function(__dep0, __dep1, __dep2, __dep3) {
const getPasteEventText = __dep0.getPasteEventText;
const isPasteEvent = __dep0.isPasteEvent;
const getString = __dep1.getString;
const simpleHash = __dep2.simpleHash;
...
const createAutosaveService = (state, editorBinder, revisionStore, panel, windowRef) => {
